...
var MasterDetails = require('../models/masterDetails');
...
exports.getMasterData = function () {
  function getMasterData(req, res) {
    ...
    masterDataService.getMasterData( function (result) {
...
exports.upload = function () {
  function upload(req, res) {
    ...
    form.on('end', () => {
      ...
      masterDataService.updateProfilePhotos(users, function (result) {
        if (result instanceof Error) {
          var data = new Data();
          data.message = 'Oops! error occured. Try after some time';
          data.status = constants.FAILED;
...
exports.getCities = function () {
  function getCities(req, res) {
    ...
    masterDataService.getCities(countryId, function (result) {
      var cities = result;
...
exports.getUserRoles = function () {
  function getUserRoles(req, res) {
    ...
    masterDataService.getUserRoles(function (result) {
